...
pub type __io_read_fn = ::std::option::Option<
    unsafe extern "C" fn(__cookie: *mut libc::c_void, __buf: *mut libc::c_char, __nbytes: usize)
        -> __ssize_t,
>;
pub type __io_write_fn = ::std::option::Option<
    unsafe extern "C" fn(__cookie: *mut libc::c_void, __buf: *const libc::c_char, __n: usize)
        -> __ssize_t,
>;
pub type __io_seek_fn = ::std::option::Option<
    unsafe extern "C" fn(__cookie: *mut libc::c_void, __pos: *mut __off64_t, __w: libc::c_int)
        -> libc::c_int,
>;
...
extern "C" {
    pub fn inet_neta(__net: in_addr_t, __buf: *mut libc::c_char, __len: usize)
        -> *mut libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn scandir(
        ...
        __selector: ::std::option::Option<unsafe extern "C" fn(arg1: *const dirent) -> libc::c_int>,
        __cmp: ::std::option::Option<
            unsafe extern "C" fn(arg1: *mut *const dirent, arg2: *mut *const dirent) -> libc::c_int,
        >,
    ) -> libc::c_int;
}
extern "C" {
    pub fn alphasort(__e1: *mut *const dirent, __e2: *mut *const dirent) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn __sigismember(arg1: *const __sigset_t, arg2: libc::c_int) -> libc::c_int;
}
extern "C" {
    pub fn __sigaddset(arg1: *mut __sigset_t, arg2: libc::c_int) -> libc::c_int;
}
extern "C" {
    pub fn __sigdelset(arg1: *mut __sigset_t, arg2: libc::c_int) -> libc::c_int;
}
...
extern "C" {
    pub fn __sigpause(__sig_or_mask: libc::c_int, __is_sig: libc::c_int) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn sigvec(__sig: libc::c_int, __vec: *const sigvec, __ovec: *mut sigvec) -> libc::c_int;
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
extern "C" {
    pub fn sigaltstack(__ss: *const sigaltstack, __oss: *mut sigaltstack) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn openlog(__ident: *const libc::c_char, __option: libc::c_int, __facility: libc::c_int);
}
extern "C" {
...
extern "C" {
    pub fn vsyslog(__pri: libc::c_int, __fmt: *const libc::c_char, __ap: *mut __va_list_tag);
}
...
pub union ifreq__bindgen_ty_1 {
    pub ifrn_name: [libc::c_char; 16usize],
...
pub union ifreq__bindgen_ty_2 {
    ...
    pub ifru_map: ifmap,
    pub ifru_slave: [libc::c_char; 16usize],
    pub ifru_newname: [libc::c_char; 16usize],
...
extern "C" {
    pub fn munmap(__addr: *mut libc::c_void, __len: usize) -> libc::c_int;
}
extern "C" {
    pub fn mprotect(__addr: *mut libc::c_void, __len: usize, __prot: libc::c_int) -> libc::c_int;
}
extern "C" {
    pub fn msync(__addr: *mut libc::c_void, __len: usize, __flags: libc::c_int) -> libc::c_int;
}
extern "C" {
    pub fn madvise(__addr: *mut libc::c_void, __len: usize, __advice: libc::c_int) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn mlock(__addr: *const libc::c_void, __len: usize) -> libc::c_int;
}
extern "C" {
    pub fn munlock(__addr: *const libc::c_void, __len: usize) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn getrlimit(__resource: __rlimit_resource_t, __rlimits: *mut rlimit) -> libc::c_int;
}
extern "C" {
    pub fn setrlimit(__resource: __rlimit_resource_t, __rlimits: *const rlimit) -> libc::c_int;
}
extern "C" {
    pub fn getrusage(__who: __rusage_who_t, __usage: *mut rusage) -> libc::c_int;
}
extern "C" {
    pub fn getpriority(__which: __priority_which_t, __who: id_t) -> libc::c_int;
}
extern "C" {
    pub fn setpriority(
...
pub struct user_fpregs_struct {
    ...
    pub st_space: [libc::c_uint; 32usize],
    pub xmm_space: [libc::c_uint; 64usize],
    pub padding: [libc::c_uint; 24usize],
}
...
pub struct user {
    ...
    pub u_fpvalid: libc::c_int,
    pub i387: user_fpregs_struct,
    pub u_tsize: libc::c_ulonglong,
    pub u_dsize: libc::c_ulonglong,
    pub u_ssize: libc::c_ulonglong,
    pub start_code: libc::c_ulonglong,
    pub start_stack: libc::c_ulonglong,
    pub signal: libc::c_longlong,
    pub reserved: libc::c_int,
    pub __bindgen_anon_1: user__bindgen_ty_1,
    pub __bindgen_anon_2: user__bindgen_ty_2,
    pub magic: libc::c_ulonglong,
    pub u_comm: [libc::c_char; 32usize],
    pub u_debugreg: [libc::c_ulonglong; 8usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union user__bindgen_ty_1 {
    pub u_ar0: *mut user_regs_struct,
    pub __u_ar0_word: libc::c_ulonglong,
    _bindgen_union_align: u64,
}
...
pub union user__bindgen_ty_2 {
    ...
    pub __u_fpstate_word: libc::c_ulonglong,
    _bindgen_union_align: u64,
}
...
pub struct spdk_env_opts {
    pub name: *const libc::c_char,
    pub core_mask: *const libc::c_char,
    pub shm_id: libc::c_int,
    pub mem_channel: libc::c_int,
    pub master_core: libc::c_int,
    pub mem_size: libc::c_int,
    pub no_pci: bool,
    ...
    pub env_context: *mut libc::c_void,
}
...
extern "C" {
    pub fn spdk_free(buf: *mut libc::c_void);
}
extern "C" {
    pub fn spdk_env_opts_init(opts: *mut spdk_env_opts);
}
extern "C" {
    pub fn spdk_env_init(opts: *const spdk_env_opts) -> libc::c_int;
}
extern "C" {
    pub fn spdk_dma_malloc(size: usize, align: usize, phys_addr: *mut u64) -> *mut libc::c_void;
}
extern "C" {
...
extern "C" {
    pub fn spdk_dma_zmalloc(size: usize, align: usize, phys_addr: *mut u64) -> *mut libc::c_void;
}
extern "C" {
...
extern "C" {
    pub fn spdk_dma_free(buf: *mut libc::c_void);
}
extern "C" {
...
extern "C" {
    pub fn spdk_memzone_lookup(name: *const libc::c_char) -> *mut libc::c_void;
}
extern "C" {
    pub fn spdk_memzone_free(name: *const libc::c_char) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spdk_mempool_get_name(mp: *mut spdk_mempool) -> *mut libc::c_char;
}
extern "C" {
    pub fn spdk_mempool_free(mp: *mut spdk_mempool);
}
extern "C" {
    pub fn spdk_mempool_get(mp: *mut spdk_mempool) -> *mut libc::c_void;
}
extern "C" {
    pub fn spdk_mempool_get_bulk(
        mp: *mut spdk_mempool,
        ele_arr: *mut *mut libc::c_void,
        count: usize,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_mempool_put(mp: *mut spdk_mempool, ele: *mut libc::c_void);
}
extern "C" {
...
extern "C" {
    pub fn spdk_delay_us(us: libc::c_uint);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn spdk_ring_count(ring: *mut spdk_ring) -> usize;
}
extern "C" {
    pub fn spdk_ring_enqueue(
        ring: *mut spdk_ring,
        objs: *mut *mut libc::c_void,
        count: usize,
    ) -> usize;
}
extern "C" {
...
extern "C" {
    pub fn spdk_vtophys(buf: *mut libc::c_void) -> u64;
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
pub type spdk_pci_enum_cb = ::std::option::Option<
    unsafe extern "C" fn(enum_ctx: *mut libc::c_void, pci_dev: *mut spdk_pci_device) -> libc::c_int,
>;
extern "C" {
    pub fn spdk_pci_nvme_enumerate(
        enum_cb: spdk_pci_enum_cb,
        enum_ctx: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_pci_ioat_enumerate(
        enum_cb: spdk_pci_enum_cb,
        enum_ctx: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_pci_virtio_enumerate(
        enum_cb: spdk_pci_enum_cb,
        enum_ctx: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_pci_device_map_bar(
        ...
        bar: u32,
        mapped_addr: *mut *mut libc::c_void,
        phys_addr: *mut u64,
        size: *mut u64,
    ) -> libc::c_int;
}
...
extern "C" {
    pub fn spdk_pci_device_get_socket_id(dev: *mut spdk_pci_device) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spdk_pci_device_claim(pci_addr: *const spdk_pci_addr) -> libc::c_int;
}
extern "C" {
    pub fn spdk_pci_device_detach(device: *mut spdk_pci_device);
}
extern "C" {
    pub fn spdk_pci_nvme_device_attach(
        enum_cb: spdk_pci_enum_cb,
        enum_ctx: *mut libc::c_void,
...
extern "C" {
    pub fn spdk_pci_ioat_device_attach(
        enum_cb: spdk_pci_enum_cb,
        enum_ctx: *mut libc::c_void,
        pci_address: *mut spdk_pci_addr,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_pci_virtio_device_attach(
        enum_cb: spdk_pci_enum_cb,
        enum_ctx: *mut libc::c_void,
        pci_address: *mut spdk_pci_addr,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_pci_addr_compare(a1: *const spdk_pci_addr, a2: *const spdk_pci_addr)
        -> libc::c_int;
}
extern "C" {
    pub fn spdk_pci_addr_parse(addr: *mut spdk_pci_addr, bdf: *const libc::c_char) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spdk_call_unaffinitized(
        cb: ::std::option::Option<
            unsafe extern "C" fn(arg: *mut libc::c_void) -> *mut libc::c_void,
        >,
        arg: *mut libc::c_void,
    ) -> *mut libc::c_void;
}
...
pub type spdk_mem_map_notify_action = u32;
...
pub type spdk_mem_map_contiguous_translations =
    ::std::option::Option<unsafe extern "C" fn(addr_1: u64, addr_2: u64) -> libc::c_int>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
impl Default for spdk_mem_map_ops {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
extern "C" {
    pub fn spdk_mem_register(vaddr: *mut libc::c_void, len: usize) -> libc::c_int;
}
extern "C" {
    pub fn spdk_mem_unregister(vaddr: *mut libc::c_void, len: usize) -> libc::c_int;
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Default for spdk_nvmf_capsule_cmd {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub type spdk_nvmf_fabric_cmd_types = u32;
...
pub type spdk_nvmf_fabric_cmd_status_code = u32;
...
pub type spdk_nvmf_treq_secure_channel = u32;
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct spdk_nvmf_fabric_auth_recv_cmd {
    pub opcode: u8,
    pub reserved1: u8,
    pub cid: u16,
    pub fctype: u8,
    pub reserved2: [u8; 19usize],
    pub sgl1: spdk_nvme_sgl_descriptor,
    pub reserved3: u8,
    pub spsp0: u8,
    pub spsp1: u8,
...
impl Default for spdk_nvmf_fabric_auth_recv_cmd {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct spdk_nvmf_fabric_auth_send_cmd {
    pub opcode: u8,
    pub reserved1: u8,
    pub cid: u16,
    pub fctype: u8,
...
impl Default for spdk_nvmf_fabric_auth_send_cmd {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl Default for spdk_nvmf_fabric_connect_data {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct spdk_nvmf_fabric_connect_cmd {
    pub opcode: u8,
    pub reserved1: u8,
    pub cid: u16,
    pub fctype: u8,
...
impl Default for spdk_nvmf_fabric_connect_cmd {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct spdk_nvmf_fabric_connect_rsp {
    pub status_code_specific: spdk_nvmf_fabric_connect_rsp__bindgen_ty_1,
    pub reserved0: u32,
    pub sqhd: u16,
    pub reserved1: u16,
    pub cid: u16,
...
impl Default for spdk_nvmf_fabric_connect_rsp__bindgen_ty_1 {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
impl Default for spdk_nvmf_fabric_connect_rsp {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl spdk_nvmf_fabric_prop_get_cmd__bindgen_ty_1 {
    ...
    #[inline]
    pub fn new_bitfield_1(size: u8, reserved: u8) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 3u8, {
...
impl Default for spdk_nvmf_fabric_prop_get_cmd {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct spdk_nvmf_fabric_prop_get_rsp {
    pub value: spdk_nvmf_fabric_prop_get_rsp__bindgen_ty_1,
    pub sqhd: u16,
    pub reserved0: u16,
    pub cid: u16,
    pub status: spdk_nvme_status,
...
pub union spdk_nvmf_fabric_prop_get_rsp__bindgen_ty_1 {
    pub u64: u64,
    pub u32: spdk_nvmf_fabric_prop_get_rsp__bindgen_ty_1__bindgen_ty_1,
...
impl Default for spdk_nvmf_fabric_prop_get_rsp__bindgen_ty_1 {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
impl Default for spdk_nvmf_fabric_prop_get_rsp {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub union spdk_nvmf_fabric_prop_set_cmd__bindgen_ty_2 {
    pub u64: u64,
    pub u32: spdk_nvmf_fabric_prop_set_cmd__bindgen_ty_2__bindgen_ty_1,
    _bindgen_union_align: [u8; 8usize],
}
#[repr(C, packed)]
#[derive(Debug, Default, Copy, Clone)]
...
impl Default for spdk_nvmf_fabric_prop_set_cmd__bindgen_ty_2 {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
impl Default for spdk_nvmf_fabric_prop_set_cmd {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl Default for spdk_nvmf_rdma_transport_specific_address_subtype {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl Default for spdk_nvmf_transport_specific_address_subtype {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl Default for spdk_nvmf_discovery_log_page_entry {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl Default for spdk_nvmf_discovery_log_page {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl Default for spdk_nvmf_rdma_private_data {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub type spdk_nvmf_rdma_transport_error = u32;
...
pub struct spdk_nvme_ctrlr_opts {
    ...
    /// specified.
    pub src_addr: [libc::c_char; 257usize],
    /// Source service ID (port) for NVMe-oF connections.
    /// Set src_addr and src_svcid to empty strings if no source address should be
    /// specified.
    pub src_svcid: [libc::c_char; 33usize],
...
pub struct spdk_nvme_transport_id {
    ...
    pub traddr: [libc::c_char; 257usize],
...
extern "C" {
    ...
    pub fn spdk_nvme_transport_id_adrfam_str(adrfam: spdk_nvmf_adrfam) -> *const libc::c_char;
}
extern "C" {
...
pub type spdk_nvme_remove_cb = ::std::option::Option<
    unsafe extern "C" fn(cb_ctx: *mut libc::c_void, ctrlr: *mut spdk_nvme_ctrlr),
>;
extern "C" {
...
extern "C" {
    ...
    ///
    /// \return 0 on success, -1 on failure.
    pub fn spdk_nvme_detach(ctrlr: *mut spdk_nvme_ctrlr) -> libc::c_int;
}
extern "C" {
    ...
    ///
    /// \return 0 on success, -1 on failure.
    pub fn spdk_nvme_ctrlr_reset(ctrlr: *mut spdk_nvme_ctrlr) -> libc::c_int;
}
extern "C" {
...
pub type spdk_nvme_cmd_cb = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut libc::c_void, arg2: *const spdk_nvme_cpl),
>;
...
pub type spdk_nvme_aer_cb = ::std::option::Option<
    unsafe extern "C" fn(aer_cb_arg: *mut libc::c_void, arg1: *const spdk_nvme_cpl),
>;
extern "C" {
...
extern "C" {
    ...
    ///
    /// \return 0 on success, -1 on failure.
    pub fn spdk_nvme_ctrlr_free_io_qpair(qpair: *mut spdk_nvme_qpair) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    ...
    /// allocated
    /// for this request
    pub fn spdk_nvme_ctrlr_delete_ns(ctrlr: *mut spdk_nvme_ctrlr, nsid: u32) -> libc::c_int;
}
extern "C" {
    /// Format NVM.
    ///
...
pub type spdk_nvme_req_reset_sgl_cb =
    ::std::option::Option<unsafe extern "C" fn(cb_arg: *mut libc::c_void, offset: u32)>;
...
extern "C" {
    pub fn spdk_cpuset_fmt(set: *mut spdk_cpuset) -> *const libc::c_char;
}
extern "C" {
    pub fn spdk_cpuset_parse(set: *mut spdk_cpuset, mask: *const libc::c_char) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spdk_log_set_backtrace_level(level: spdk_log_level);
}
extern "C" {
    pub fn spdk_log_get_backtrace_level() -> spdk_log_level;
}
extern "C" {
...
extern "C" {
    pub fn spdk_log_get_trace_flag(flag: *const libc::c_char) -> bool;
}
extern "C" {
    pub fn spdk_log_set_trace_flag(flag: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    pub fn spdk_log_clear_trace_flag(flag: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    pub fn spdk_tracelog_usage(f: *mut FILE, trace_arg: *const libc::c_char);
}
/// Event handler function.
///
/// \param arg1 Argument 1.
/// \param arg2 Argument 2.
pub type spdk_event_fn =
...
pub struct spdk_app_opts {
    ...
    pub rpc_addr: *const libc::c_char,
    pub reactor_mask: *const libc::c_char,
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_reactor_tsc_stats {
    pub busy_tsc: u64,
    pub idle_tsc: u64,
    pub unknown_tsc: u64,
}
...
extern "C" {
    ...
    pub fn spdk_app_stop(rc: libc::c_int);
}
extern "C" {
    ...
    pub fn spdk_app_get_running_config(
        config_str: *mut *mut libc::c_char,
...
extern "C" {
    ...
    pub fn spdk_app_get_shm_id() -> libc::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn spdk_app_parse_args(
        ...
        opts: *mut spdk_app_opts,
        getopt_str: *const libc::c_char,
        app_long_opts: *mut option,
        parse: ::std::option::Option<unsafe extern "C" fn(ch: libc::c_int, arg: *mut libc::c_char)>,
...
extern "C" {
    ...
    pub fn spdk_reactor_get_tsc_stats(
        tsc_stats: *mut spdk_reactor_tsc_stats,
        core_id: u32,
    ) -> libc::c_int;
}
pub const spdk_scsi_group_code_SPDK_SCSI_6BYTE_CMD: spdk_scsi_group_code = 0;
pub const spdk_scsi_group_code_SPDK_SCSI_10BYTE_CMD: spdk_scsi_group_code = 32;
pub const spdk_scsi_group_code_SPDK_SCSI_10BYTE_CMD2: spdk_scsi_group_code = 64;
pub const spdk_scsi_group_code_SPDK_SCSI_16BYTE_CMD: spdk_scsi_group_code = 128;
pub const spdk_scsi_group_code_SPDK_SCSI_12BYTE_CMD: spdk_scsi_group_code = 160;
pub type spdk_scsi_group_code = u32;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_GOOD: spdk_scsi_status = 0;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_CHECK_CONDITION: spdk_scsi_status = 2;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_CONDITION_MET: spdk_scsi_status = 4;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_BUSY: spdk_scsi_status = 8;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_INTERMEDIATE: spdk_scsi_status = 16;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_INTERMEDIATE_CONDITION_MET: spdk_scsi_status = 20;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_RESERVATION_CONFLICT: spdk_scsi_status = 24;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_Obsolete: spdk_scsi_status = 34;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_TASK_SET_FULL: spdk_scsi_status = 40;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_ACA_ACTIVE: spdk_scsi_status = 48;
pub const spdk_scsi_status_SPDK_SCSI_STATUS_TASK_ABORTED: spdk_scsi_status = 64;
pub type spdk_scsi_status = u32;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_NO_SENSE: spdk_scsi_sense = 0;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_RECOVERED_ERROR: spdk_scsi_sense = 1;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_NOT_READY: spdk_scsi_sense = 2;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_MEDIUM_ERROR: spdk_scsi_sense = 3;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_HARDWARE_ERROR: spdk_scsi_sense = 4;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_ILLEGAL_REQUEST: spdk_scsi_sense = 5;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_UNIT_ATTENTION: spdk_scsi_sense = 6;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_DATA_PROTECT: spdk_scsi_sense = 7;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_BLANK_CHECK: spdk_scsi_sense = 8;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_VENDOR_SPECIFIC: spdk_scsi_sense = 9;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_COPY_ABORTED: spdk_scsi_sense = 10;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_ABORTED_COMMAND: spdk_scsi_sense = 11;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_VOLUME_OVERFLOW: spdk_scsi_sense = 13;
pub const spdk_scsi_sense_SPDK_SCSI_SENSE_MISCOMPARE: spdk_scsi_sense = 14;
pub type spdk_scsi_sense = u32;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_NO_ADDITIONAL_SENSE: spdk_scsi_asc = 0;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_PERIPHERAL_DEVICE_WRITE_FAULT: spdk_scsi_asc = 3;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_LOGICAL_UNIT_NOT_READY: spdk_scsi_asc = 4;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_WARNING: spdk_scsi_asc = 11;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_LOGICAL_BLOCK_GUARD_CHECK_FAILED: spdk_scsi_asc = 16;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_LOGICAL_BLOCK_APP_TAG_CHECK_FAILED: spdk_scsi_asc = 16;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_LOGICAL_BLOCK_REF_TAG_CHECK_FAILED: spdk_scsi_asc = 16;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_UNRECOVERED_READ_ERROR: spdk_scsi_asc = 17;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_MISCOMPARE_DURING_VERIFY_OPERATION: spdk_scsi_asc = 29;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_INVALID_COMMAND_OPERATION_CODE: spdk_scsi_asc = 32;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_ACCESS_DENIED: spdk_scsi_asc = 32;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_LOGICAL_BLOCK_ADDRESS_OUT_OF_RANGE: spdk_scsi_asc = 33;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_INVALID_FIELD_IN_CDB: spdk_scsi_asc = 36;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_LOGICAL_UNIT_NOT_SUPPORTED: spdk_scsi_asc = 37;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_WRITE_PROTECTED: spdk_scsi_asc = 39;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_FORMAT_COMMAND_FAILED: spdk_scsi_asc = 49;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_SAVING_PARAMETERS_NOT_SUPPORTED: spdk_scsi_asc = 57;
pub const spdk_scsi_asc_SPDK_SCSI_ASC_INTERNAL_TARGET_FAILURE: spdk_scsi_asc = 68;
pub type spdk_scsi_asc = u32;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_CAUSE_NOT_REPORTABLE: spdk_scsi_ascq = 0;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_BECOMING_READY: spdk_scsi_ascq = 1;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_FORMAT_COMMAND_FAILED: spdk_scsi_ascq = 1;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_LOGICAL_BLOCK_GUARD_CHECK_FAILED: spdk_scsi_ascq = 1;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_LOGICAL_BLOCK_APP_TAG_CHECK_FAILED: spdk_scsi_ascq = 2;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_NO_ACCESS_RIGHTS: spdk_scsi_ascq = 2;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_LOGICAL_BLOCK_REF_TAG_CHECK_FAILED: spdk_scsi_ascq = 3;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_POWER_LOSS_EXPECTED: spdk_scsi_ascq = 8;
pub const spdk_scsi_ascq_SPDK_SCSI_ASCQ_INVALID_LU_IDENTIFIER: spdk_scsi_ascq = 9;
pub type spdk_scsi_ascq = u32;
pub const spdk_spc_opcode_SPDK_SPC_ACCESS_CONTROL_IN: spdk_spc_opcode = 134;
pub const spdk_spc_opcode_SPDK_SPC_ACCESS_CONTROL_OUT: spdk_spc_opcode = 135;
pub const spdk_spc_opcode_SPDK_SPC_EXTENDED_COPY: spdk_spc_opcode = 131;
pub const spdk_spc_opcode_SPDK_SPC_INQUIRY: spdk_spc_opcode = 18;
pub const spdk_spc_opcode_SPDK_SPC_LOG_SELECT: spdk_spc_opcode = 76;
pub const spdk_spc_opcode_SPDK_SPC_LOG_SENSE: spdk_spc_opcode = 77;
pub const spdk_spc_opcode_SPDK_SPC_MODE_SELECT_6: spdk_spc_opcode = 21;
pub const spdk_spc_opcode_SPDK_SPC_MODE_SELECT_10: spdk_spc_opcode = 85;
pub const spdk_spc_opcode_SPDK_SPC_MODE_SENSE_6: spdk_spc_opcode = 26;
pub const spdk_spc_opcode_SPDK_SPC_MODE_SENSE_10: spdk_spc_opcode = 90;
pub const spdk_spc_opcode_SPDK_SPC_PERSISTENT_RESERVE_IN: spdk_spc_opcode = 94;
pub const spdk_spc_opcode_SPDK_SPC_PERSISTENT_RESERVE_OUT: spdk_spc_opcode = 95;
pub const spdk_spc_opcode_SPDK_SPC_PREVENT_ALLOW_MEDIUM_REMOVAL: spdk_spc_opcode = 30;
pub const spdk_spc_opcode_SPDK_SPC_READ_ATTRIBUTE: spdk_spc_opcode = 140;
pub const spdk_spc_opcode_SPDK_SPC_READ_BUFFER: spdk_spc_opcode = 60;
pub const spdk_spc_opcode_SPDK_SPC_RECEIVE_COPY_RESULTS: spdk_spc_opcode = 132;
pub const spdk_spc_opcode_SPDK_SPC_RECEIVE_DIAGNOSTIC_RESULTS: spdk_spc_opcode = 28;
pub const spdk_spc_opcode_SPDK_SPC_REPORT_LUNS: spdk_spc_opcode = 160;
pub const spdk_spc_opcode_SPDK_SPC_REQUEST_SENSE: spdk_spc_opcode = 3;
pub const spdk_spc_opcode_SPDK_SPC_SEND_DIAGNOSTIC: spdk_spc_opcode = 29;
pub const spdk_spc_opcode_SPDK_SPC_TEST_UNIT_READY: spdk_spc_opcode = 0;
pub const spdk_spc_opcode_SPDK_SPC_WRITE_ATTRIBUTE: spdk_spc_opcode = 141;
pub const spdk_spc_opcode_SPDK_SPC_WRITE_BUFFER: spdk_spc_opcode = 59;
pub const spdk_spc_opcode_SPDK_SPC_SERVICE_ACTION_IN_12: spdk_spc_opcode = 171;
pub const spdk_spc_opcode_SPDK_SPC_SERVICE_ACTION_OUT_12: spdk_spc_opcode = 169;
pub const spdk_spc_opcode_SPDK_SPC_SERVICE_ACTION_IN_16: spdk_spc_opcode = 158;
pub const spdk_spc_opcode_SPDK_SPC_SERVICE_ACTION_OUT_16: spdk_spc_opcode = 159;
pub const spdk_spc_opcode_SPDK_SPC_VARIABLE_LENGTH: spdk_spc_opcode = 127;
pub const spdk_spc_opcode_SPDK_SPC_MO_CHANGE_ALIASES: spdk_spc_opcode = 11;
pub const spdk_spc_opcode_SPDK_SPC_MO_SET_DEVICE_IDENTIFIER: spdk_spc_opcode = 6;
pub const spdk_spc_opcode_SPDK_SPC_MO_SET_PRIORITY: spdk_spc_opcode = 14;
pub const spdk_spc_opcode_SPDK_SPC_MO_SET_TARGET_PORT_GROUPS: spdk_spc_opcode = 10;
pub const spdk_spc_opcode_SPDK_SPC_MO_SET_TIMESTAMP: spdk_spc_opcode = 15;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_ALIASES: spdk_spc_opcode = 11;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_DEVICE_IDENTIFIER: spdk_spc_opcode = 5;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_PRIORITY: spdk_spc_opcode = 14;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_SUPPORTED_OPERATION_CODES: spdk_spc_opcode = 12;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_SUPPORTED_TASK_MANAGEMENT_FUNCTIONS: spdk_spc_opcode =
    13;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_TARGET_PORT_GROUPS: spdk_spc_opcode = 10;
pub const spdk_spc_opcode_SPDK_SPC_MI_REPORT_TIMESTAMP: spdk_spc_opcode = 15;
pub const spdk_spc_opcode_SPDK_SPC2_RELEASE_6: spdk_spc_opcode = 23;
pub const spdk_spc_opcode_SPDK_SPC2_RELEASE_10: spdk_spc_opcode = 87;
pub const spdk_spc_opcode_SPDK_SPC2_RESERVE_6: spdk_spc_opcode = 22;
pub const spdk_spc_opcode_SPDK_SPC2_RESERVE_10: spdk_spc_opcode = 86;
pub type spdk_spc_opcode = u32;
pub const spdk_scc_opcode_SPDK_SCC_MAINTENANCE_IN: spdk_scc_opcode = 163;
pub const spdk_scc_opcode_SPDK_SCC_MAINTENANCE_OUT: spdk_scc_opcode = 164;
pub type spdk_scc_opcode = u32;
pub const spdk_sbc_opcode_SPDK_SBC_COMPARE_AND_WRITE: spdk_sbc_opcode = 137;
pub const spdk_sbc_opcode_SPDK_SBC_FORMAT_UNIT: spdk_sbc_opcode = 4;
pub const spdk_sbc_opcode_SPDK_SBC_GET_LBA_STATUS: spdk_sbc_opcode = 1179806;
pub const spdk_sbc_opcode_SPDK_SBC_ORWRITE_16: spdk_sbc_opcode = 139;
pub const spdk_sbc_opcode_SPDK_SBC_PRE_FETCH_10: spdk_sbc_opcode = 52;
pub const spdk_sbc_opcode_SPDK_SBC_PRE_FETCH_16: spdk_sbc_opcode = 144;
pub const spdk_sbc_opcode_SPDK_SBC_READ_6: spdk_sbc_opcode = 8;
pub const spdk_sbc_opcode_SPDK_SBC_READ_10: spdk_sbc_opcode = 40;
pub const spdk_sbc_opcode_SPDK_SBC_READ_12: spdk_sbc_opcode = 168;
pub const spdk_sbc_opcode_SPDK_SBC_READ_16: spdk_sbc_opcode = 136;
pub const spdk_sbc_opcode_SPDK_SBC_READ_ATTRIBUTE: spdk_sbc_opcode = 140;
pub const spdk_sbc_opcode_SPDK_SBC_READ_BUFFER: spdk_sbc_opcode = 60;
pub const spdk_sbc_opcode_SPDK_SBC_READ_CAPACITY_10: spdk_sbc_opcode = 37;
pub const spdk_sbc_opcode_SPDK_SBC_READ_DEFECT_DATA_10: spdk_sbc_opcode = 55;
pub const spdk_sbc_opcode_SPDK_SBC_READ_DEFECT_DATA_12: spdk_sbc_opcode = 183;
pub const spdk_sbc_opcode_SPDK_SBC_READ_LONG_10: spdk_sbc_opcode = 62;
pub const spdk_sbc_opcode_SPDK_SBC_REASSIGN_BLOCKS: spdk_sbc_opcode = 7;
pub const spdk_sbc_opcode_SPDK_SBC_SANITIZE: spdk_sbc_opcode = 72;
pub const spdk_sbc_opcode_SPDK_SBC_START_STOP_UNIT: spdk_sbc_opcode = 27;
pub const spdk_sbc_opcode_SPDK_SBC_SYNCHRONIZE_CACHE_10: spdk_sbc_opcode = 53;
pub const spdk_sbc_opcode_SPDK_SBC_SYNCHRONIZE_CACHE_16: spdk_sbc_opcode = 145;
pub const spdk_sbc_opcode_SPDK_SBC_UNMAP: spdk_sbc_opcode = 66;
pub const spdk_sbc_opcode_SPDK_SBC_VERIFY_10: spdk_sbc_opcode = 47;
pub const spdk_sbc_opcode_SPDK_SBC_VERIFY_12: spdk_sbc_opcode = 175;
pub const spdk_sbc_opcode_SPDK_SBC_VERIFY_16: spdk_sbc_opcode = 143;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_6: spdk_sbc_opcode = 10;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_10: spdk_sbc_opcode = 42;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_12: spdk_sbc_opcode = 170;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_16: spdk_sbc_opcode = 138;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_AND_VERIFY_10: spdk_sbc_opcode = 46;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_AND_VERIFY_12: spdk_sbc_opcode = 174;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_AND_VERIFY_16: spdk_sbc_opcode = 142;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_LONG_10: spdk_sbc_opcode = 63;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_SAME_10: spdk_sbc_opcode = 65;
pub const spdk_sbc_opcode_SPDK_SBC_WRITE_SAME_16: spdk_sbc_opcode = 147;
pub const spdk_sbc_opcode_SPDK_SBC_XDREAD_10: spdk_sbc_opcode = 82;
pub const spdk_sbc_opcode_SPDK_SBC_XDWRITE_10: spdk_sbc_opcode = 80;
pub const spdk_sbc_opcode_SPDK_SBC_XDWRITEREAD_10: spdk_sbc_opcode = 83;
pub const spdk_sbc_opcode_SPDK_SBC_XPWRITE_10: spdk_sbc_opcode = 81;
pub const spdk_sbc_opcode_SPDK_SBC_SAI_READ_CAPACITY_16: spdk_sbc_opcode = 16;
pub const spdk_sbc_opcode_SPDK_SBC_SAI_READ_LONG_16: spdk_sbc_opcode = 17;
pub const spdk_sbc_opcode_SPDK_SBC_SAO_WRITE_LONG_16: spdk_sbc_opcode = 17;
pub const spdk_sbc_opcode_SPDK_SBC_VL_READ_32: spdk_sbc_opcode = 9;
pub const spdk_sbc_opcode_SPDK_SBC_VL_VERIFY_32: spdk_sbc_opcode = 10;
pub const spdk_sbc_opcode_SPDK_SBC_VL_WRITE_32: spdk_sbc_opcode = 11;
pub const spdk_sbc_opcode_SPDK_SBC_VL_WRITE_AND_VERIFY_32: spdk_sbc_opcode = 12;
pub const spdk_sbc_opcode_SPDK_SBC_VL_WRITE_SAME_32: spdk_sbc_opcode = 13;
pub const spdk_sbc_opcode_SPDK_SBC_VL_XDREAD_32: spdk_sbc_opcode = 3;
pub const spdk_sbc_opcode_SPDK_SBC_VL_XDWRITE_32: spdk_sbc_opcode = 4;
pub const spdk_sbc_opcode_SPDK_SBC_VL_XDWRITEREAD_32: spdk_sbc_opcode = 7;
pub const spdk_sbc_opcode_SPDK_SBC_VL_XPWRITE_32: spdk_sbc_opcode = 6;
pub type spdk_sbc_opcode = u32;
pub const spdk_mmc_opcode_SPDK_MMC_READ_DISC_STRUCTURE: spdk_mmc_opcode = 173;
pub const spdk_mmc_opcode_SPDK_MMC_BLANK: spdk_mmc_opcode = 161;
pub const spdk_mmc_opcode_SPDK_MMC_CLOSE_TRACK_SESSION: spdk_mmc_opcode = 91;
pub const spdk_mmc_opcode_SPDK_MMC_ERASE_10: spdk_mmc_opcode = 44;
pub const spdk_mmc_opcode_SPDK_MMC_FORMAT_UNIT: spdk_mmc_opcode = 4;
pub const spdk_mmc_opcode_SPDK_MMC_GET_CONFIGURATION: spdk_mmc_opcode = 70;
pub const spdk_mmc_opcode_SPDK_MMC_GET_EVENT_STATUS_NOTIFICATION: spdk_mmc_opcode = 74;
pub const spdk_mmc_opcode_SPDK_MMC_GET_PERFORMANCE: spdk_mmc_opcode = 172;
pub const spdk_mmc_opcode_SPDK_MMC_INQUIRY: spdk_mmc_opcode = 18;
pub const spdk_mmc_opcode_SPDK_MMC_LOAD_UNLOAD_MEDIUM: spdk_mmc_opcode = 166;
pub const spdk_mmc_opcode_SPDK_MMC_MECHANISM_STATUS: spdk_mmc_opcode = 189;
pub const spdk_mmc_opcode_SPDK_MMC_MODE_SELECT_10: spdk_mmc_opcode = 85;
pub const spdk_mmc_opcode_SPDK_MMC_MODE_SENSE_10: spdk_mmc_opcode = 90;
pub const spdk_mmc_opcode_SPDK_MMC_PAUSE_RESUME: spdk_mmc_opcode = 75;
pub const spdk_mmc_opcode_SPDK_MMC_PLAY_AUDIO_10: spdk_mmc_opcode = 69;
pub const spdk_mmc_opcode_SPDK_MMC_PLAY_AUDIO_12: spdk_mmc_opcode = 165;
pub const spdk_mmc_opcode_SPDK_MMC_PLAY_AUDIO_MSF: spdk_mmc_opcode = 71;
pub const spdk_mmc_opcode_SPDK_MMC_PREVENT_ALLOW_MEDIUM_REMOVAL: spdk_mmc_opcode = 30;
pub const spdk_mmc_opcode_SPDK_MMC_READ_10: spdk_mmc_opcode = 40;
pub const spdk_mmc_opcode_SPDK_MMC_READ_12: spdk_mmc_opcode = 168;
pub const spdk_mmc_opcode_SPDK_MMC_READ_BUFFER: spdk_mmc_opcode = 60;
pub const spdk_mmc_opcode_SPDK_MMC_READ_BUFFER_CAPACITY: spdk_mmc_opcode = 92;
pub const spdk_mmc_opcode_SPDK_MMC_READ_CAPACITY: spdk_mmc_opcode = 37;
pub const spdk_mmc_opcode_SPDK_MMC_READ_CD: spdk_mmc_opcode = 190;
pub const spdk_mmc_opcode_SPDK_MMC_READ_CD_MSF: spdk_mmc_opcode = 185;
pub const spdk_mmc_opcode_SPDK_MMC_READ_DISC_INFORMATION: spdk_mmc_opcode = 81;
pub const spdk_mmc_opcode_SPDK_MMC_READ_DVD_STRUCTURE: spdk_mmc_opcode = 173;
pub const spdk_mmc_opcode_SPDK_MMC_READ_FORMAT_CAPACITIES: spdk_mmc_opcode = 35;
pub const spdk_mmc_opcode_SPDK_MMC_READ_SUB_CHANNEL: spdk_mmc_opcode = 66;
pub const spdk_mmc_opcode_SPDK_MMC_READ_TOC_PMA_ATIP: spdk_mmc_opcode = 67;
pub const spdk_mmc_opcode_SPDK_MMC_READ_TRACK_INFORMATION: spdk_mmc_opcode = 82;
pub const spdk_mmc_opcode_SPDK_MMC_REPAIR_TRACK: spdk_mmc_opcode = 88;
pub const spdk_mmc_opcode_SPDK_MMC_REPORT_KEY: spdk_mmc_opcode = 164;
pub const spdk_mmc_opcode_SPDK_MMC_REQUEST_SENSE: spdk_mmc_opcode = 3;
pub const spdk_mmc_opcode_SPDK_MMC_RESERVE_TRACK: spdk_mmc_opcode = 83;
pub const spdk_mmc_opcode_SPDK_MMC_SCAN: spdk_mmc_opcode = 186;
pub const spdk_mmc_opcode_SPDK_MMC_SEEK_10: spdk_mmc_opcode = 43;
pub const spdk_mmc_opcode_SPDK_MMC_SEND_CUE_SHEET: spdk_mmc_opcode = 93;
pub const spdk_mmc_opcode_SPDK_MMC_SEND_DVD_STRUCTURE: spdk_mmc_opcode = 191;
pub const spdk_mmc_opcode_SPDK_MMC_SEND_KEY: spdk_mmc_opcode = 163;
pub const spdk_mmc_opcode_SPDK_MMC_SEND_OPC_INFORMATION: spdk_mmc_opcode = 84;
pub const spdk_mmc_opcode_SPDK_MMC_SET_CD_SPEED: spdk_mmc_opcode = 187;
pub const spdk_mmc_opcode_SPDK_MMC_SET_READ_AHEAD: spdk_mmc_opcode = 167;
pub const spdk_mmc_opcode_SPDK_MMC_SET_STREAMING: spdk_mmc_opcode = 182;
pub const spdk_mmc_opcode_SPDK_MMC_START_STOP_UNIT: spdk_mmc_opcode = 27;
pub const spdk_mmc_opcode_SPDK_MMC_STOP_PLAY_SCAN: spdk_mmc_opcode = 78;
pub const spdk_mmc_opcode_SPDK_MMC_SYNCHRONIZE_CACHE: spdk_mmc_opcode = 53;
pub const spdk_mmc_opcode_SPDK_MMC_TEST_UNIT_READY: spdk_mmc_opcode = 0;
pub const spdk_mmc_opcode_SPDK_MMC_VERIFY_10: spdk_mmc_opcode = 47;
pub const spdk_mmc_opcode_SPDK_MMC_WRITE_10: spdk_mmc_opcode = 162;
pub const spdk_mmc_opcode_SPDK_MMC_WRITE_12: spdk_mmc_opcode = 170;
pub const spdk_mmc_opcode_SPDK_MMC_WRITE_AND_VERIFY_10: spdk_mmc_opcode = 46;
pub const spdk_mmc_opcode_SPDK_MMC_WRITE_BUFFER: spdk_mmc_opcode = 59;
pub type spdk_mmc_opcode = u32;
pub const spdk_ssc_opcode_SPDK_SSC_ERASE_6: spdk_ssc_opcode = 25;
pub const spdk_ssc_opcode_SPDK_SSC_FORMAT_MEDIUM: spdk_ssc_opcode = 4;
pub const spdk_ssc_opcode_SPDK_SSC_LOAD_UNLOAD: spdk_ssc_opcode = 27;
pub const spdk_ssc_opcode_SPDK_SSC_LOCATE_10: spdk_ssc_opcode = 43;
pub const spdk_ssc_opcode_SPDK_SSC_LOCATE_16: spdk_ssc_opcode = 146;
pub const spdk_ssc_opcode_SPDK_SSC_MOVE_MEDIUM_ATTACHED: spdk_ssc_opcode = 167;
pub const spdk_ssc_opcode_SPDK_SSC_READ_6: spdk_ssc_opcode = 8;
pub const spdk_ssc_opcode_SPDK_SSC_READ_BLOCK_LIMITS: spdk_ssc_opcode = 5;
pub const spdk_ssc_opcode_SPDK_SSC_READ_ELEMENT_STATUS_ATTACHED: spdk_ssc_opcode = 180;
pub const spdk_ssc_opcode_SPDK_SSC_READ_POSITION: spdk_ssc_opcode = 52;
pub const spdk_ssc_opcode_SPDK_SSC_READ_REVERSE_6: spdk_ssc_opcode = 15;
pub const spdk_ssc_opcode_SPDK_SSC_RECOVER_BUFFERED_DATA: spdk_ssc_opcode = 20;
pub const spdk_ssc_opcode_SPDK_SSC_REPORT_DENSITY_SUPPORT: spdk_ssc_opcode = 68;
pub const spdk_ssc_opcode_SPDK_SSC_REWIND: spdk_ssc_opcode = 1;
pub const spdk_ssc_opcode_SPDK_SSC_SET_CAPACITY: spdk_ssc_opcode = 11;
pub const spdk_ssc_opcode_SPDK_SSC_SPACE_6: spdk_ssc_opcode = 17;
pub const spdk_ssc_opcode_SPDK_SSC_SPACE_16: spdk_ssc_opcode = 145;
pub const spdk_ssc_opcode_SPDK_SSC_VERIFY_6: spdk_ssc_opcode = 19;
pub const spdk_ssc_opcode_SPDK_SSC_WRITE_6: spdk_ssc_opcode = 10;
pub const spdk_ssc_opcode_SPDK_SSC_WRITE_FILEMARKS_6: spdk_ssc_opcode = 16;
pub type spdk_ssc_opcode = u32;
pub const spdk_spc_vpd_SPDK_SPC_VPD_DEVICE_IDENTIFICATION: spdk_spc_vpd = 131;
pub const spdk_spc_vpd_SPDK_SPC_VPD_EXTENDED_INQUIRY_DATA: spdk_spc_vpd = 134;
pub const spdk_spc_vpd_SPDK_SPC_VPD_MANAGEMENT_NETWORK_ADDRESSES: spdk_spc_vpd = 133;
pub const spdk_spc_vpd_SPDK_SPC_VPD_MODE_PAGE_POLICY: spdk_spc_vpd = 135;
pub const spdk_spc_vpd_SPDK_SPC_VPD_SCSI_PORTS: spdk_spc_vpd = 136;
pub const spdk_spc_vpd_SPDK_SPC_VPD_SOFTWARE_INTERFACE_IDENTIFICATION: spdk_spc_vpd = 132;
pub const spdk_spc_vpd_SPDK_SPC_VPD_SUPPORTED_VPD_PAGES: spdk_spc_vpd = 0;
pub const spdk_spc_vpd_SPDK_SPC_VPD_UNIT_SERIAL_NUMBER: spdk_spc_vpd = 128;
pub const spdk_spc_vpd_SPDK_SPC_VPD_BLOCK_LIMITS: spdk_spc_vpd = 176;
pub const spdk_spc_vpd_SPDK_SPC_VPD_BLOCK_DEV_CHARS: spdk_spc_vpd = 177;
pub const spdk_spc_vpd_SPDK_SPC_VPD_BLOCK_THIN_PROVISION: spdk_spc_vpd = 178;
pub type spdk_spc_vpd = u32;
pub const spdk_spc_peripheral_qualifier_SPDK_SPC_PERIPHERAL_QUALIFIER_CONNECTED:
    spdk_spc_peripheral_qualifier = 0;
pub const spdk_spc_peripheral_qualifier_SPDK_SPC_PERIPHERAL_QUALIFIER_NOT_CONNECTED:
    spdk_spc_peripheral_qualifier = 1;
pub const spdk_spc_peripheral_qualifier_SPDK_SPC_PERIPHERAL_QUALIFIER_NOT_CAPABLE:
    spdk_spc_peripheral_qualifier = 3;
pub type spdk_spc_peripheral_qualifier = u32;
pub const SPDK_SPC_PERIPHERAL_DEVICE_TYPE_DISK: _bindgen_ty_35 = 0;
pub const SPDK_SPC_PERIPHERAL_DEVICE_TYPE_TAPE: _bindgen_ty_35 = 1;
pub const SPDK_SPC_PERIPHERAL_DEVICE_TYPE_DVD: _bindgen_ty_35 = 5;
pub const SPDK_SPC_PERIPHERAL_DEVICE_TYPE_CHANGER: _bindgen_ty_35 = 8;
pub const SPDK_SPC_VERSION_NONE: _bindgen_ty_35 = 0;
pub const SPDK_SPC_VERSION_SPC: _bindgen_ty_35 = 3;
pub const SPDK_SPC_VERSION_SPC2: _bindgen_ty_35 = 4;
pub const SPDK_SPC_VERSION_SPC3: _bindgen_ty_35 = 5;
pub const SPDK_SPC_VERSION_SPC4: _bindgen_ty_35 = 6;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_FC: _bindgen_ty_35 = 0;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_PSCSI: _bindgen_ty_35 = 1;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_SSA: _bindgen_ty_35 = 2;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_IEEE1394: _bindgen_ty_35 = 3;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_RDMA: _bindgen_ty_35 = 4;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_ISCSI: _bindgen_ty_35 = 5;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_SAS: _bindgen_ty_35 = 6;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_ADT: _bindgen_ty_35 = 7;
pub const SPDK_SPC_PROTOCOL_IDENTIFIER_ATA: _bindgen_ty_35 = 8;
pub const SPDK_SPC_VPD_CODE_SET_BINARY: _bindgen_ty_35 = 1;
pub const SPDK_SPC_VPD_CODE_SET_ASCII: _bindgen_ty_35 = 2;
pub const SPDK_SPC_VPD_CODE_SET_UTF8: _bindgen_ty_35 = 3;
pub const SPDK_SPC_VPD_ASSOCIATION_LOGICAL_UNIT: _bindgen_ty_35 = 0;
pub const SPDK_SPC_VPD_ASSOCIATION_TARGET_PORT: _bindgen_ty_35 = 1;
pub const SPDK_SPC_VPD_ASSOCIATION_TARGET_DEVICE: _bindgen_ty_35 = 2;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_VENDOR_SPECIFIC: _bindgen_ty_35 = 0;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_T10_VENDOR_ID: _bindgen_ty_35 = 1;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_EUI64: _bindgen_ty_35 = 2;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_NAA: _bindgen_ty_35 = 3;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_RELATIVE_TARGET_PORT: _bindgen_ty_35 = 4;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_TARGET_PORT_GROUP: _bindgen_ty_35 = 5;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_LOGICAL_UNIT_GROUP: _bindgen_ty_35 = 6;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_MD5_LOGICAL_UNIT: _bindgen_ty_35 = 7;
pub const SPDK_SPC_VPD_IDENTIFIER_TYPE_SCSI_NAME: _bindgen_ty_35 = 8;
pub type _bindgen_ty_35 = u32;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_scsi_cdb_inquiry {
    pub opcode: u8,
    pub evpd: u8,
    pub page_code: u8,
    pub alloc_len: [u8; 2usize],
    pub control: u8,
}
#[repr(C)]
#[derive(Debug, Default)]
pub struct spdk_scsi_cdb_inquiry_data {
    pub _bitfield_1: __BindgenBitfieldUnit<[u8; 1usize], u8>,
    pub rmb: u8,
    pub version: u8,
    pub response: u8,
    ...
    pub flags2: u8,
    pub flags3: u8,
    pub t10_vendor_id: [u8; 8usize],
    pub product_id: [u8; 16usize],
    pub product_rev: [u8; 4usize],
    pub vendor: [u8; 20usize],
    pub ius: u8,
    pub reserved: u8,
    pub desc: __IncompleteArrayField<u8>,
}
impl spdk_scsi_cdb_inquiry_data {
    #[inline]
    pub fn peripheral_device_type(&self) -> u8 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 5u8) as u8) }
    }
    #[inline]
    pub fn set_peripheral_device_type(&mut self, val: u8) {
        unsafe {
            let val: u8 = ::std::mem::transmute(val);
            self._bitfield_1.set(0usize, 5u8, val as u64)
        }
    ...
    #[inline]
    pub fn set_peripheral_qualifier(&mut self, val: u8) {
        unsafe {
            let val: u8 = ::std::mem::transmute(val);
            self._bitfield_1.set(5usize, 3u8, val as u64)
        }
    ...
    pub fn new_bitfield_1(
        ...
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 5u8, {
            let peripheral_device_type: u8 =
                unsafe { ::std::mem::transmute(peripheral_device_type) };
            peripheral_device_type as u64
        });
        __bindgen_bitfield_unit.set(5usize, 3u8, {
            let peripheral_qualifier: u8 = unsafe { ::std::mem::transmute(peripheral_qualifier) };
            peripheral_qualifier as u64
        });
        __bindgen_bitfield_unit
    }
}
#[repr(C)]
#[derive(Debug, Default)]
pub struct spdk_scsi_vpd_page {
    pub _bitfield_1: __BindgenBitfieldUnit<[u8; 1usize], u8>,
    pub page_code: u8,
    pub alloc_len: [u8; 2usize],
    pub params: __IncompleteArrayField<u8>,
}
impl spdk_scsi_vpd_page {
    #[inline]
    pub fn peripheral_device_type(&self) -> u8 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 5u8) as u8) }
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spdk_scsi_vpd_ext_inquiry {
    pub peripheral: u8,
    pub page_code: u8,
    pub alloc_len: [u8; 2usize],
    pub check: u8,
...
impl Default for spdk_scsi_vpd_ext_inquiry {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C)]
#[derive(Debug, Default)]
pub struct spdk_scsi_desig_desc {
    pub _bitfield_1: __BindgenBitfieldUnit<[u8; 2usize], u8>,
    pub reserved1: u8,
    pub len: u8,
    pub desig: __IncompleteArrayField<u8>,
}
impl spdk_scsi_desig_desc {
    #[inline]
    pub fn code_set(&self) -> u8 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 4u8) as u8) }
    }
    #[inline]
    pub fn set_code_set(&mut self, val: u8) {
        unsafe {
            let val: u8 = ::std::mem::transmute(val);
            self._bitfield_1.set(0usize, 4u8, val as u64)
        }
    ...
    #[inline]
    pub fn set_protocol_id(&mut self, val: u8) {
        unsafe {
            let val: u8 = ::std::mem::transmute(val);
            self._bitfield_1.set(4usize, 4u8, val as u64)
        }
    ...
    #[inline]
    pub fn set_association(&mut self, val: u8) {
        unsafe {
            let val: u8 = ::std::mem::transmute(val);
            self._bitfield_1.set(12usize, 2u8, val as u64)
        }
    ...
    #[inline]
    pub fn set_piv(&mut self, val: u8) {
        unsafe {
            let val: u8 = ::std::mem::transmute(val);
            self._bitfield_1.set(15usize, 1u8, val as u64)
        }
    ...
    pub fn new_bitfield_1(
        ...
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 2usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 4u8, {
            let code_set: u8 = unsafe { ::std::mem::transmute(code_set) };
            code_set as u64
        });
        __bindgen_bitfield_unit.set(4usize, 4u8, {
            let protocol_id: u8 = unsafe { ::std::mem::transmute(protocol_id) };
            protocol_id as u64
        });
        __bindgen_bitfield_unit.set(8usize, 4u8, {
            let type_: u8 = unsafe { ::std::mem::transmute(type_) };
        ...
        __bindgen_bitfield_unit.set(12usize, 2u8, {
            let association: u8 = unsafe { ::std::mem::transmute(association) };
            association as u64
        });
        __bindgen_bitfield_unit.set(14usize, 1u8, {
        ...
        __bindgen_bitfield_unit.set(15usize, 1u8, {
            let piv: u8 = unsafe { ::std::mem::transmute(piv) };
            piv as u64
        });
        __bindgen_bitfield_unit
    }
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_scsi_mpage_policy_desc {
    pub page_code: u8,
...
#[repr(C)]
#[derive(Debug, Default)]
pub struct spdk_scsi_tgt_port_desc {
    pub code_set: u8,
    pub desig_type: u8,
    pub reserved: u8,
    pub len: u8,
    pub designator: __IncompleteArrayField<u8>,
}
#[repr(C)]
#[derive(Debug, Default)]
pub struct spdk_scsi_port_desc {
    pub reserved: u16,
    pub rel_port_id: u16,
    pub reserved2: u16,
    pub init_port_len: u16,
    pub init_port_id: u16,
    pub reserved3: u16,
    pub tgt_desc_len: u16,
    pub tgt_desc: __IncompleteArrayField<u8>,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_scsi_unmap_bdesc {
    pub lba: u64,
    pub block_count: u32,
    pub reserved: u32,
}
pub const spdk_json_val_type_SPDK_JSON_VAL_INVALID: spdk_json_val_type = 0;
pub const spdk_json_val_type_SPDK_JSON_VAL_NULL: spdk_json_val_type = 1;
pub const spdk_json_val_type_SPDK_JSON_VAL_TRUE: spdk_json_val_type = 2;
pub const spdk_json_val_type_SPDK_JSON_VAL_FALSE: spdk_json_val_type = 3;
pub const spdk_json_val_type_SPDK_JSON_VAL_NUMBER: spdk_json_val_type = 4;
pub const spdk_json_val_type_SPDK_JSON_VAL_STRING: spdk_json_val_type = 5;
pub const spdk_json_val_type_SPDK_JSON_VAL_ARRAY_BEGIN: spdk_json_val_type = 6;
pub const spdk_json_val_type_SPDK_JSON_VAL_ARRAY_END: spdk_json_val_type = 7;
pub const spdk_json_val_type_SPDK_JSON_VAL_OBJECT_BEGIN: spdk_json_val_type = 8;
pub const spdk_json_val_type_SPDK_JSON_VAL_OBJECT_END: spdk_json_val_type = 9;
pub const spdk_json_val_type_SPDK_JSON_VAL_NAME: spdk_json_val_type = 10;
pub type spdk_json_val_type = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_json_val {
    pub start: *mut libc::c_void,
    pub len: u32,
    pub type_: spdk_json_val_type,
}
impl Default for spdk_json_val {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    pub fn spdk_json_parse(
        json: *mut libc::c_void,
        size: usize,
        values: *mut spdk_json_val,
        num_values: usize,
        end: *mut *mut libc::c_void,
        flags: u32,
    ) -> isize;
}
pub type spdk_json_decode_fn = ::std::option::Option<
    unsafe extern "C" fn(val: *const spdk_json_val, out: *mut libc::c_void) -> libc::c_int,
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_json_object_decoder {
    pub name: *const libc::c_char,
    pub offset: usize,
    pub decode_func: spdk_json_decode_fn,
    pub optional: bool,
}
impl Default for spdk_json_object_decoder {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    pub fn spdk_json_decode_object(
        values: *const spdk_json_val,
        decoders: *const spdk_json_object_decoder,
        num_decoders: usize,
        out: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_decode_array(
        values: *const spdk_json_val,
...
extern "C" {
    pub fn spdk_json_decode_bool(val: *const spdk_json_val, out: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_decode_uint16(
        val: *const spdk_json_val,
        out: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_decode_int32(val: *const spdk_json_val, out: *mut libc::c_void)
        -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_decode_uint32(
        val: *const spdk_json_val,
        out: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_decode_uint64(
        val: *const spdk_json_val,
        out: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_decode_string(
        val: *const spdk_json_val,
        out: *mut libc::c_void,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_val_len(val: *const spdk_json_val) -> usize;
}
extern "C" {
    pub fn spdk_json_strequal(val: *const spdk_json_val, str: *const libc::c_char) -> bool;
}
extern "C" {
    pub fn spdk_json_strdup(val: *const spdk_json_val) -> *mut libc::c_char;
}
extern "C" {
    pub fn spdk_json_number_to_uint16(val: *const spdk_json_val, num: *mut u16) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_number_to_int32(val: *const spdk_json_val, num: *mut i32) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_number_to_uint32(val: *const spdk_json_val, num: *mut u32) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_number_to_uint64(val: *const spdk_json_val, num: *mut u64) -> libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_json_write_ctx {
    _unused: [u8; 0],
}
pub type spdk_json_write_cb = ::std::option::Option<
    unsafe extern "C" fn(cb_ctx: *mut libc::c_void, data: *const libc::c_void, size: usize)
        -> libc::c_int,
>;
extern "C" {
    pub fn spdk_json_write_begin(
        write_cb: spdk_json_write_cb,
        cb_ctx: *mut libc::c_void,
        flags: u32,
    ) -> *mut spdk_json_write_ctx;
}
extern "C" {
    pub fn spdk_json_write_end(w: *mut spdk_json_write_ctx) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_null(w: *mut spdk_json_write_ctx) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_bool(w: *mut spdk_json_write_ctx, val: bool) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_int32(w: *mut spdk_json_write_ctx, val: i32) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_uint32(w: *mut spdk_json_write_ctx, val: u32) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_int64(w: *mut spdk_json_write_ctx, val: i64) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_uint64(w: *mut spdk_json_write_ctx, val: u64) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spdk_json_write_string_raw(
        w: *mut spdk_json_write_ctx,
        val: *const libc::c_char,
        len: usize,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_string_utf16le(
        w: *mut spdk_json_write_ctx,
        val: *const u16,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_string_utf16le_raw(
        w: *mut spdk_json_write_ctx,
        val: *const u16,
        len: usize,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_string_fmt(
        w: *mut spdk_json_write_ctx,
...
extern "C" {
    pub fn spdk_json_write_string_fmt_v(
        w: *mut spdk_json_write_ctx,
        fmt: *const libc::c_char,
...
extern "C" {
    pub fn spdk_json_write_array_begin(w: *mut spdk_json_write_ctx) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_array_end(w: *mut spdk_json_write_ctx) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_object_begin(w: *mut spdk_json_write_ctx) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_object_end(w: *mut spdk_json_write_ctx) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_name(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_name_raw(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        len: usize,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_val(
        w: *mut spdk_json_write_ctx,
        val: *const spdk_json_val,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_val_raw(
        w: *mut spdk_json_write_ctx,
...
extern "C" {
    pub fn spdk_json_write_named_null(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spdk_json_write_named_bool(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        val: bool,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_named_int32(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        val: i32,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_named_uint32(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        val: u32,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_named_uint64(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        val: u64,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_named_int64(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        val: i64,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_named_string(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        val: *const libc::c_char,
    ) -> libc::c_int;
...
extern "C" {
    pub fn spdk_json_write_named_string_fmt(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        fmt: *const libc::c_char,
        ...
...
extern "C" {
    pub fn spdk_json_write_named_string_fmt_v(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
        fmt: *const libc::c_char,
        args: *mut __va_list_tag,
...
extern "C" {
    pub fn spdk_json_write_named_object_begin(
        w: *mut spdk_json_write_ctx,
        name: *const libc::c_char,
    ) -> libc::c_int;
}
...
pub type spdk_bdev_remove_cb_t =
    ::std::option::Option<unsafe extern "C" fn(remove_ctx: *mut libc::c_void)>;
/// Block device I/O
///
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bdev_fn_table {
    _unused: [u8; 0],
}
pub const spdk_bdev_status_SPDK_BDEV_STATUS_INVALID: spdk_bdev_status = 0;
pub const spdk_bdev_status_SPDK_BDEV_STATUS_READY: spdk_bdev_status = 1;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bdev_desc {
    _unused: [u8; 0],
}
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_INVALID: spdk_bdev_io_type = 0;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_READ: spdk_bdev_io_type = 1;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_WRITE: spdk_bdev_io_type = 2;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_UNMAP: spdk_bdev_io_type = 3;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_FLUSH: spdk_bdev_io_type = 4;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_RESET: spdk_bdev_io_type = 5;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_NVME_ADMIN: spdk_bdev_io_type = 6;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_NVME_IO: spdk_bdev_io_type = 7;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_NVME_IO_MD: spdk_bdev_io_type = 8;
pub const spdk_bdev_io_type_SPDK_BDEV_IO_TYPE_WRITE_ZEROES: spdk_bdev_io_type = 9;
pub const spdk_bdev_io_type_SPDK_BDEV_NUM_IO_TYPES: spdk_bdev_io_type = 10;
/// bdev I/O type
pub type spdk_bdev_io_type = u32;
/// IOPS rate limit for both read and write
pub const spdk_bdev_qos_rate_limit_type_SPDK_BDEV_QOS_RW_IOPS_RATE_LIMIT:
    spdk_bdev_qos_rate_limit_type = 0;
/// Byte per second rate limit for both read and write
pub const spdk_bdev_qos_rate_limit_type_SPDK_BDEV_QOS_RW_BPS_RATE_LIMIT:
    spdk_bdev_qos_rate_limit_type = 1;
/// Keep last
pub const spdk_bdev_qos_rate_limit_type_SPDK_BDEV_QOS_NUM_RATE_LIMIT_TYPES:
    spdk_bdev_qos_rate_limit_type = 2;
...
pub type spdk_bdev_io_completion_cb = ::std::option::Option<
    unsafe extern "C" fn(bdev_io: *mut spdk_bdev_io, success: bool, cb_arg: *mut libc::c_void),
>;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_bdev_io_stat {
    pub bytes_read: u64,
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_bdev_opts {
    pub bdev_io_pool_size: u32,
    pub bdev_io_cache_size: u32,
}
extern "C" {
    pub fn spdk_bdev_get_opts(opts: *mut spdk_bdev_opts);
}
extern "C" {
    pub fn spdk_bdev_set_opts(opts: *mut spdk_bdev_opts) -> libc::c_int;
}
...
pub type spdk_bdev_init_cb =
    ::std::option::Option<unsafe extern "C" fn(cb_arg: *mut libc::c_void, rc: libc::c_int)>;
/// Block device finish callback.
///
/// \param cb_arg Callback argument.
pub type spdk_bdev_fini_cb = ::std::option::Option<unsafe extern "C" fn(cb_arg: *mut libc::c_void)>;
pub type spdk_bdev_get_device_stat_cb = ::std::option::Option<
    unsafe extern "C" fn(
        bdev: *mut spdk_bdev,
        stat: *mut spdk_bdev_io_stat,
        cb_arg: *mut libc::c_void,
        rc: libc::c_int,
    ),
>;
extern "C" {
    ...
    pub fn spdk_bdev_initialize(cb_fn: spdk_bdev_init_cb, cb_arg: *mut libc::c_void);
}
extern "C" {
    ...
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bdev_finish(cb_fn: spdk_bdev_fini_cb, cb_arg: *mut libc::c_void);
}
extern "C" {
    ...
    pub fn spdk_bdev_config_text(fp: *mut FILE);
}
extern "C" {
    ...
    pub fn spdk_bdev_subsystem_config_json(w: *mut spdk_json_write_ctx);
}
extern "C" {
    ...
    pub fn spdk_bdev_get_by_name(bdev_name: *const libc::c_char) -> *mut spdk_bdev;
}
extern "C" {
    /// Get the first registered block device.
    ///
    /// \return The first registered block device.
    pub fn spdk_bdev_first() -> *mut spdk_bdev;
}
extern "C" {
    ...
    pub fn spdk_bdev_next(prev: *mut spdk_bdev) -> *mut spdk_bdev;
}
extern "C" {
    ...
    pub fn spdk_bdev_first_leaf() -> *mut spdk_bdev;
}
extern "C" {
    ...
    pub fn spdk_bdev_next_leaf(prev: *mut spdk_bdev) -> *mut spdk_bdev;
}
extern "C" {
    ...
    pub fn spdk_bdev_open(
        bdev: *mut spdk_bdev,
        write: bool,
        remove_cb: spdk_bdev_remove_cb_t,
        remove_ctx: *mut libc::c_void,
...
extern "C" {
    ...
    pub fn spdk_bdev_io_type_supported(bdev: *mut spdk_bdev, io_type: spdk_bdev_io_type) -> bool;
}
extern "C" {
    ...
    /// \return 0 on success, negated errno on failure.
    pub fn spdk_bdev_dump_info_json(
        bdev: *mut spdk_bdev,
        w: *mut spdk_json_write_ctx,
    ) -> libc::c_int;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_name(bdev: *const spdk_bdev) -> *const libc::c_char;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_product_name(bdev: *const spdk_bdev) -> *const libc::c_char;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_block_size(bdev: *const spdk_bdev) -> u32;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_num_blocks(bdev: *const spdk_bdev) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_qos_rpc_type(type_: spdk_bdev_qos_rate_limit_type) -> *const libc::c_char;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_qos_rate_limits(bdev: *mut spdk_bdev, limits: *mut u64);
}
extern "C" {
    ...
    ///
    /// The limits are ordered based on the @ref spdk_bdev_qos_rate_limit_type enum.
    pub fn spdk_bdev_set_qos_rate_limits(
        bdev: *mut spdk_bdev,
        limits: *mut u64,
        cb_fn: ::std::option::Option<
            unsafe extern "C" fn(cb_arg: *mut libc::c_void, status: libc::c_int),
        >,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
    ...
    pub fn spdk_bdev_get_buf_align(bdev: *const spdk_bdev) -> usize;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_optimal_io_boundary(bdev: *const spdk_bdev) -> u32;
}
extern "C" {
    ...
    /// is issued.
    pub fn spdk_bdev_has_write_cache(bdev: *const spdk_bdev) -> bool;
}
extern "C" {
    /// Get a bdev's UUID.
    ///
    ...
    pub fn spdk_bdev_get_uuid(bdev: *const spdk_bdev) -> *const spdk_uuid;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_qd(bdev: *const spdk_bdev) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_qd_sampling_period(bdev: *const spdk_bdev) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bdev_set_qd_sampling_period(bdev: *mut spdk_bdev, period: u64);
}
extern "C" {
    ...
    pub fn spdk_bdev_get_io_time(bdev: *const spdk_bdev) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_weighted_io_time(bdev: *const spdk_bdev) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bdev_get_io_channel(desc: *mut spdk_bdev_desc) -> *mut spdk_io_channel;
}
extern "C" {
...
extern "C" {
    ...
    ///   * -ENOMEM - spdk_bdev_io buffer cannot be allocated
    ///   * -EBADF - desc not open for writing
    pub fn spdk_bdev_write_zeroes_blocks(
        desc: *mut spdk_bdev_desc,
        ch: *mut spdk_io_channel,
        offset_blocks: u64,
        num_blocks: u64,
...
extern "C" {
    ...
    ///   * -ENOMEM - spdk_bdev_io buffer cannot be allocated
    ///   * -EBADF - desc not open for writing
    pub fn spdk_bdev_nvme_admin_passthru(
        desc: *mut spdk_bdev_desc,
        ch: *mut spdk_io_channel,
        cmd: *const spdk_nvme_cmd,
        buf: *mut libc::c_void,
        nbytes: usize,
        cb: spdk_bdev_io_completion_cb,
        cb_arg: *mut libc::c_void,
...
extern "C" {
    ...
    ///   * -ENOMEM - spdk_bdev_io buffer cannot be allocated
    ///   * -EBADF - desc not open for writing
    pub fn spdk_bdev_nvme_io_passthru(
...
extern "C" {
    ...
    ///   * -ENOMEM - spdk_bdev_io buffer cannot be allocated
    ///   * -EBADF - desc not open for writing
    pub fn spdk_bdev_nvme_io_passthru_md(
        bdev_desc: *mut spdk_bdev_desc,
        ch: *mut spdk_io_channel,
        cmd: *const spdk_nvme_cmd,
        buf: *mut libc::c_void,
...
pub type spdk_bdev_io_wait_cb =
    ::std::option::Option<unsafe extern "C" fn(cb_arg: *mut libc::c_void)>;
/// Structure to register a callback when an spdk_bdev_io becomes available.
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bdev_io_wait_entry {
    pub bdev: *mut spdk_bdev,
    pub cb_fn: spdk_bdev_io_wait_cb,
    pub cb_arg: *mut libc::c_void,
    pub link: spdk_bdev_io_wait_entry__bindgen_ty_1,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bdev_io_wait_entry__bindgen_ty_1 {
    pub tqe_next: *mut spdk_bdev_io_wait_entry,
    pub tqe_prev: *mut *mut spdk_bdev_io_wait_entry,
}
impl Default for spdk_bdev_io_wait_entry__bindgen_ty_1 {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
impl Default for spdk_bdev_io_wait_entry {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    ...
    pub fn spdk_bdev_queue_io_wait(
        bdev: *mut spdk_bdev,
        ch: *mut spdk_io_channel,
        entry: *mut spdk_bdev_io_wait_entry,
    ) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    ...
    /// \param cb_arg Argument passed to callback function.
    pub fn spdk_bdev_get_device_stat(
        bdev: *mut spdk_bdev,
        stat: *mut spdk_bdev_io_stat,
        cb: spdk_bdev_get_device_stat_cb,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
    ...
    pub fn spdk_bdev_io_get_nvme_status(
        bdev_io: *const spdk_bdev_io,
        sct: *mut libc::c_int,
        sc: *mut libc::c_int,
    );
}
extern "C" {
    ...
    pub fn spdk_bdev_io_get_scsi_status(
        bdev_io: *const spdk_bdev_io,
        sc: *mut libc::c_int,
        sk: *mut libc::c_int,
        asc: *mut libc::c_int,
...
extern "C" {
    ...
    pub fn spdk_bdev_io_get_iovec(
        bdev_io: *mut spdk_bdev_io,
        iovp: *mut *mut iovec,
        iovcntp: *mut libc::c_int,
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bdev_module {
    _unused: [u8; 0],
}
extern "C" {
    ...
    pub fn spdk_bdev_create_bs_dev(
        bdev: *mut spdk_bdev,
        remove_cb: spdk_bdev_remove_cb_t,
        remove_ctx: *mut libc::c_void,
    ) -> *mut spdk_bs_dev;
...
extern "C" {
    ...
    pub fn spdk_bs_bdev_claim(
        bs_dev: *mut spdk_bs_dev,
        module: *mut spdk_bdev_module,
    ) -> libc::c_int;
}
pub type spdk_blob_id = u64;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_blob_store {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_blob {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_xattr_names {
    _unused: [u8; 0],
}
...
pub type spdk_bs_op_complete =
    ::std::option::Option<unsafe extern "C" fn(cb_arg: *mut libc::c_void, bserrno: libc::c_int)>;
/// Blobstore operation completion callback with handle.
///
/// \param cb_arg Callback argument.
/// \param bs Handle to a blobstore.
/// \param bserrno 0 if it completed successfully, or negative errno if it failed.
pub type spdk_bs_op_with_handle_complete = ::std::option::Option<
    unsafe extern "C" fn(cb_arg: *mut libc::c_void, bs: *mut spdk_blob_store, bserrno: libc::c_int),
>;
/// Blob operation completion callback.
///
/// \param cb_arg Callback argument.
/// \param bserrno 0 if it completed successfully, or negative errno if it failed.
pub type spdk_blob_op_complete =
    ::std::option::Option<unsafe extern "C" fn(cb_arg: *mut libc::c_void, bserrno: libc::c_int)>;
...
/// \param bserrno 0 if it completed successfully, or negative errno if it failed.
pub type spdk_blob_op_with_id_complete = ::std::option::Option<
    unsafe extern "C" fn(cb_arg: *mut libc::c_void, blobid: spdk_blob_id, bserrno: libc::c_int),
>;
...
/// \param bserrno 0 if it completed successfully, or negative errno if it failed.
pub type spdk_blob_op_with_handle_complete = ::std::option::Option<
    unsafe extern "C" fn(cb_arg: *mut libc::c_void, blb: *mut spdk_blob, bserrno: libc::c_int),
>;
...
/// \param cb_arg Callback argument.
/// \param bserrno 0 if it completed successfully, or negative errno if it failed.
pub type spdk_bs_dev_cpl = ::std::option::Option<
    unsafe extern "C" fn(
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bs_dev_cb_args {
    pub cb_fn: spdk_bs_dev_cpl,
    pub channel: *mut spdk_io_channel,
    pub cb_arg: *mut libc::c_void,
}
impl Default for spdk_bs_dev_cb_args {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bs_dev {
    pub create_channel:
        ::std::option::Option<unsafe extern "C" fn(dev: *mut spdk_bs_dev) -> *mut spdk_io_channel>,
    pub destroy_channel: ::std::option::Option<
        unsafe extern "C" fn(dev: *mut spdk_bs_dev, channel: *mut spdk_io_channel),
    >,
    pub destroy: ::std::option::Option<unsafe extern "C" fn(dev: *mut spdk_bs_dev)>,
    pub read: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            lba: u64,
            lba_count: u32,
            cb_args: *mut spdk_bs_dev_cb_args,
        ),
    >,
    ...
    >,
    pub write_zeroes: ::std::option::Option<
        unsafe extern "C" fn(
            dev: *mut spdk_bs_dev,
            channel: *mut spdk_io_channel,
            lba: u64,
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct spdk_bs_type {
    pub bstype: [libc::c_char; 16usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_bs_opts {
    ...
    /// Blobstore type
    pub bstype: spdk_bs_type,
    /// Callback function to invoke for each blob.
    pub iter_cb_fn: spdk_blob_op_with_handle_complete,
    /// Argument passed to iter_cb_fn for each blob.
    pub iter_cb_arg: *mut libc::c_void,
}
impl Default for spdk_bs_opts {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    ...
    pub fn spdk_bs_opts_init(opts: *mut spdk_bs_opts);
}
extern "C" {
    ...
    pub fn spdk_bs_load(
        dev: *mut spdk_bs_dev,
        opts: *mut spdk_bs_opts,
        cb_fn: spdk_bs_op_with_handle_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
...
pub type spdk_bs_dump_print_xattr = ::std::option::Option<
    unsafe extern "C" fn(
        fp: *mut FILE,
        bstype: *const libc::c_char,
        name: *const libc::c_char,
...
extern "C" {
    ...
    pub fn spdk_bs_dump(
        dev: *mut spdk_bs_dev,
        fp: *mut FILE,
        print_xattr_fn: spdk_bs_dump_print_xattr,
        cb_fn: spdk_bs_op_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
    ...
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_destroy(
        bs: *mut spdk_blob_store,
        cb_fn: spdk_bs_op_complete,
        cb_arg: *mut libc::c_void,
    );
}
...
extern "C" {
    ...
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_get_super(
        bs: *mut spdk_blob_store,
        cb_fn: spdk_blob_op_with_id_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
    ...
    ///
    /// \return cluster size.
    pub fn spdk_bs_get_cluster_size(bs: *mut spdk_blob_store) -> u64;
}
extern "C" {
    ...
    ///
    /// \return page size.
    pub fn spdk_bs_get_page_size(bs: *mut spdk_blob_store) -> u64;
}
extern "C" {
    ...
    ///
    /// \return io unit size.
    pub fn spdk_bs_get_io_unit_size(bs: *mut spdk_blob_store) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bs_free_cluster_count(bs: *mut spdk_blob_store) -> u64;
}
extern "C" {
    ...
    pub fn spdk_bs_total_data_cluster_count(bs: *mut spdk_blob_store) -> u64;
}
extern "C" {
    /// Get the blob id.
    ///
    ...
    ///
    /// \return blob id.
    pub fn spdk_blob_get_id(blob: *mut spdk_blob) -> spdk_blob_id;
}
extern "C" {
    ...
    pub fn spdk_blob_get_num_pages(blob: *mut spdk_blob) -> u64;
}
extern "C" {
    ...
    pub fn spdk_blob_get_num_io_units(blob: *mut spdk_blob) -> u64;
}
extern "C" {
    ...
    pub fn spdk_blob_get_num_clusters(blob: *mut spdk_blob) -> u64;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_blob_xattr_opts {
    pub count: usize,
    pub names: *mut *mut libc::c_char,
    pub ctx: *mut libc::c_void,
    pub get_value: ::std::option::Option<
        unsafe extern "C" fn(
            xattr_ctx: *mut libc::c_void,
            name: *const libc::c_char,
...
impl Default for spdk_blob_xattr_opts {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct spdk_blob_opts {
    pub num_clusters: u64,
    pub thin_provision: bool,
    pub xattrs: spdk_blob_xattr_opts,
}
impl Default for spdk_blob_opts {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    ...
    pub fn spdk_blob_opts_init(opts: *mut spdk_blob_opts);
}
extern "C" {
    ...
    pub fn spdk_bs_create_blob_ext(
        bs: *mut spdk_blob_store,
        opts: *const spdk_blob_opts,
        cb_fn: spdk_blob_op_with_id_complete,
        cb_arg: *mut libc::c_void,
    );
}
...
extern "C" {
    ...
    /// \param cb_fn Called when the operation is complete.
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_create_snapshot(
        bs: *mut spdk_blob_store,
        blobid: spdk_blob_id,
        snapshot_xattrs: *const spdk_blob_xattr_opts,
        cb_fn: spdk_blob_op_with_id_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
    ...
    /// \param cb_fn Called when the operation is complete.
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_create_clone(
        bs: *mut spdk_blob_store,
        blobid: spdk_blob_id,
        clone_xattrs: *const spdk_blob_xattr_opts,
        cb_fn: spdk_blob_op_with_id_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
    ...
    pub fn spdk_blob_get_clones(
        bs: *mut spdk_blob_store,
        blobid: spdk_blob_id,
        ids: *mut spdk_blob_id,
        count: *mut usize,
    ) -> libc::c_int;
}
extern "C" {
    ...
    pub fn spdk_blob_get_parent_snapshot(
        bs: *mut spdk_blob_store,
        blobid: spdk_blob_id,
    ) -> spdk_blob_id;
}
extern "C" {
    ...
    pub fn spdk_blob_is_read_only(blob: *mut spdk_blob) -> bool;
}
extern "C" {
    ...
    pub fn spdk_blob_is_snapshot(blob: *mut spdk_blob) -> bool;
}
extern "C" {
    ...
    pub fn spdk_blob_is_clone(blob: *mut spdk_blob) -> bool;
}
extern "C" {
    ...
    pub fn spdk_blob_is_thin_provisioned(blob: *mut spdk_blob) -> bool;
}
extern "C" {
    ...
    /// \param cb_fn Called when the operation is complete.
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_delete_blob(
        bs: *mut spdk_blob_store,
        blobid: spdk_blob_id,
        cb_fn: spdk_blob_op_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
...
extern "C" {
    ...
    /// \param cb_fn Called when the operation is complete.
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_blob_decouple_parent(
        bs: *mut spdk_blob_store,
        channel: *mut spdk_io_channel,
        blobid: spdk_blob_id,
        cb_fn: spdk_blob_op_complete,
...
extern "C" {
    ...
    /// \param cb_fn Called when the operation is complete.
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_bs_open_blob(
        bs: *mut spdk_blob_store,
        blobid: spdk_blob_id,
        cb_fn: spdk_blob_op_with_handle_complete,
        cb_arg: *mut libc::c_void,
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn spdk_blob_set_read_only(blob: *mut spdk_blob) -> libc::c_int;
}
extern "C" {
    /// Sync a blob.
    ///
...
extern "C" {
    ...
    pub fn spdk_bs_alloc_io_channel(bs: *mut spdk_blob_store) -> *mut spdk_io_channel;
}
extern "C" {
    /// Free the I/O channel.
    ///
    /// \param channel I/O channel to free.
    pub fn spdk_bs_free_io_channel(channel: *mut spdk_io_channel);
}
extern "C" {
...
extern "C" {
    ...
    /// \param cb_fn Called when the operation is complete.
    /// \param cb_arg Argument passed to function cb_fn.
    pub fn spdk_blob_io_write_zeroes(
        blob: *mut spdk_blob,
        channel: *mut spdk_io_channel,
        offset: u64,
        length: u64,
...
extern "C" {
    ...
    ///
    /// \return 0 on success, negative errno on failure.
    pub fn spdk_blob_remove_xattr(blob: *mut spdk_blob, name: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    ...
    ///
    /// \return 0 on success, negative errno on failure.
    pub fn spdk_blob_get_xattr_value(
        blob: *mut spdk_blob,
        name: *const libc::c_char,
        value: *mut *const libc::c_void,
        value_len: *mut usize,
...
extern "C" {
    ...
    ///
    /// \return 0 on success, negative errno on failure.
    pub fn spdk_blob_get_xattr_names(
        blob: *mut spdk_blob,
        names: *mut *mut spdk_xattr_names,
    ) -> libc::c_int;
}
extern "C" {
    ...
    pub fn spdk_xattr_names_get_count(names: *mut spdk_xattr_names) -> u32;
}
extern "C" {
    ...
    pub fn spdk_xattr_names_get_name(
        names: *mut spdk_xattr_names,
        index: u32,
    ) -> *const libc::c_char;
}
extern "C" {
    ...
    ///
    /// \param names Names of total extended attributes of the blob.
    pub fn spdk_xattr_names_free(names: *mut spdk_xattr_names);
}
extern "C" {
    ...
    pub fn spdk_bs_get_bstype(bs: *mut spdk_blob_store) -> spdk_bs_type;
}
extern "C" {
    ...
    pub fn spdk_bs_set_bstype(bs: *mut spdk_blob_store, bstype: spdk_bs_type);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type spdk_thread_fn = ::std::option::Option<unsafe extern "C" fn(ctx: *mut libc::c_void)>;
pub type spdk_thread_pass_msg = ::std::option::Option<
    unsafe extern "C" fn(
        fn_: spdk_thread_fn,
        ctx: *mut libc::c_void,
        thread_ctx: *mut libc::c_void,
    ),
>;
pub type spdk_poller_fn =
...
pub type spdk_stop_poller = ::std::option::Option<
    unsafe extern "C" fn(poller: *mut spdk_poller, thread_ctx: *mut libc::c_void),
>;
pub type spdk_io_channel_create_cb = ::std::option::Option<
    unsafe extern "C" fn(io_device: *mut libc::c_void, ctx_buf: *mut libc::c_void) -> libc::c_int,
>;
pub type spdk_io_channel_destroy_cb = ::std::option::Option<
    unsafe extern "C" fn(io_device: *mut libc::c_void, ctx_buf: *mut libc::c_void),
>;
pub type spdk_io_device_unregister_cb =
    ::std::option::Option<unsafe extern "C" fn(io_device: *mut libc::c_void)>;
pub type spdk_channel_msg =
    ::std::option::Option<unsafe extern "C" fn(i: *mut spdk_io_channel_iter)>;
pub type spdk_channel_for_each_cpl =
    ::std::option::Option<unsafe extern "C" fn(i: *mut spdk_io_channel_iter, status: libc::c_int)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
impl Default for spdk_io_channel__bindgen_ty_1 {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
impl Default for spdk_io_channel {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
extern "C" {
    pub fn spdk_thread_lib_init() -> libc::c_int;
}
extern "C" {
    pub fn spdk_thread_lib_fini();
}
extern "C" {
    pub fn spdk_allocate_thread(
        msg_fn: spdk_thread_pass_msg,
        start_poller_fn: spdk_start_poller,
        stop_poller_fn: spdk_stop_poller,
        thread_ctx: *mut libc::c_void,
        name: *const libc::c_char,
    ) -> *mut spdk_thread;
}
extern "C" {
    pub fn spdk_free_thread();
}
extern "C" {
...
extern "C" {
    pub fn spdk_thread_get_name(thread: *const spdk_thread) -> *const libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn spdk_for_each_thread(fn_: spdk_thread_fn, ctx: *mut libc::c_void, cpl: spdk_thread_fn);
}
extern "C" {
...
extern "C" {
    pub fn spdk_get_io_channel(io_device: *mut libc::c_void) -> *mut spdk_io_channel;
}
extern "C" {
    pub fn spdk_put_io_channel(ch: *mut spdk_io_channel);
}
extern "C" {
    pub fn spdk_io_channel_from_ctx(ctx: *mut libc::c_void) -> *mut spdk_io_channel;
}
extern "C" {
...
extern "C" {
    pub fn spdk_io_channel_iter_get_io_device(i: *mut spdk_io_channel_iter) -> *mut libc::c_void;
}
extern "C" {
    pub fn spdk_io_channel_iter_get_channel(i: *mut spdk_io_channel_iter) -> *mut spdk_io_channel;
}
extern "C" {
    pub fn spdk_io_channel_iter_get_ctx(i: *mut spdk_io_channel_iter) -> *mut libc::c_void;
}
extern "C" {
    pub fn spdk_for_each_channel_continue(i: *mut spdk_io_channel_iter, status: libc::c_int);
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
